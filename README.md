...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tornado-sqlalchemy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2621&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tornado-sqlalchemy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tornado-sqlalchemy` can be installed with:

```
conda install tornado-sqlalchemy
```

It is possible to list all of the versions of `tornado-sqlalchemy` available on your platform with:
